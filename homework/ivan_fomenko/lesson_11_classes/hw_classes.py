...
for book in books_list:
    if book.reserved:
        print(f'Название: {book.book_name}, Автор: {book.author}, '
              f'страниц: {book.pages},  материал: {book.material_page}, зарезервинована')
    else:
        print(f'Название: {book.book_name}, Автор: '
              f'{book.author}, страниц: {book.pages},  материал: {book.material_page}')
...
for book in school_book_list:
    if book.reserved:
        print(f'Название: {book.book_name}, Автор: {book.author}, страниц: {book.pages}, '
              f'предмет: {book.school_predmet}, класс: {book.school_class}, зарезервирована')
    else:
        print(f'Название: {book.book_name}, Автор: {book.author}, страниц: {book.pages}, '
              f'предмет: {book.school_predmet}, класс: {book.school_class}')
